        ...
        handler: async (response) => {
          try {
            ...
            const paymentVerification = await axios.post(
              ...
              {
                order_id: response.razorpay_order_id, // Extract order_id from response
            ...
            if (paymentVerification.data.success) {
              ...
              // Prepare data to confirm the order
              ...
              const confirmOrder = await axios.post(
                ...
                confirmOrderData // Sending the order data to the /confirm endpoint
              );
  
              console.log("Order confirmed:", confirmOrder);
